...
modes. Version 0.54.1. See [CHANGELOG.md](CHANGELOG.md).
...
(0.54.1 is the current published release; v0.50 through v0.53.1 were withdrawn;
0.54.0 and 0.53.2 remain available).
...
the desktop app. For the GUI, download `chorusdraft-v0.54.1-<os>-<arch>` and
