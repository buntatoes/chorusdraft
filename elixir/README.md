...
Development lives on the `elixir-experimental` branch.
...
The feature implementation includes both clients, AI adapters, all Ruby
...
read-only Ruby 0.51.1 baseline and their verification. The
[Elixir verification workflow](https://github.com/buntatoes/chorusdraft/actions/workflows/elixir.yml)
runs 64 tests using fixtures and loopback servers on Ubuntu 22.04, macOS 14, and
...
- `ChorusDraft-elixir-0.52.0-testing-linux.tar.gz`
- `ChorusDraft-elixir-0.52.0-testing-macos.tar.gz`
- `ChorusDraft-elixir-0.52.0-testing-windows.zip`
