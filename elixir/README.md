...
This directory contains the Elixir ChorusDraft 0.51.3 implementation for Linux,
macOS, and Windows. One application and executable support both Bluesky and
Mastodon. Ruby 0.51.3 ships alongside it as a supported implementation with
separate Bluesky and Mastodon packages.
...
Ruby 0.51.3 implementation and their verification. The
...
generated by the Ruby implementation in the same commit. No live credentials or
...
Compatible Ruby state can be imported explicitly as described below. Kernel locks
...
repository root and Ruby is installed. CI supplies this automatically;
