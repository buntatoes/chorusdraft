...
0.53.0: publication screening lives in proprietary ChorusDraft Guard; the bot refuses to run if Guard is missing. Earlier GitHub Releases keep their notes; packages for those versions are not published.
