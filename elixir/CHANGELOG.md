...
- Added the shared Ruby/Elixir launcher and combined platform downloads.
- Added short commands for setup, drafting, review, posts, replies, quotes,
  search, discovery, monitoring, and deletion. Existing flags remain supported.
- Retained separate configuration and account state for each implementation.
...
The initial port used `0.51.3-testing` as an internal build identifier.
