defmodule ChorusDraft.Guard.Safety do
  @moduledoc """
  Proprietary ChorusDraft Guard screening. Not licensed under Apache 2.0.
  See `elixir/guard/LICENSE`.
  """
  alias ChorusDraft.Error
  alias ChorusDraft.Guard.PII
