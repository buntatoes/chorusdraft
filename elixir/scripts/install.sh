...
mkdir -m 700 "$dest"
for item in chorusdraft run.sh setup.sh install.sh bluesky mastodon source README.md RELEASE_NOTES.md CHANGELOG.md SECURITY.md LICENSE GUARD_LICENSE NOTICE THIRD_PARTY_NOTICES.md VERSION MANIFEST.sha256; do
