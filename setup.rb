...
abort 'No ChorusDraft configuration template found in that directory.' unless File.file?(File.join(base, '.env.example'))
...
puts 'Setup complete. Edit .env, then run ruby chorusdraft.rb --help. No services were started.'
