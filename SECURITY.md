...
|---|---|---|
| 0.53.2 | Elixir | Current (published GitHub Release) |
| Prior versions | Not published as GitHub Releases | Unsupported |
...
enable commands: the Elixir README Service section.
