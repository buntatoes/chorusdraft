...
An AI-assisted writing and publishing tool for Bluesky and Mastodon, powered by
Elixir with a React desktop interface.

Draft posts, replies, and commentary, then review each draft before publishing.
Manage your account credentials and recall recent posts from one desktop window.
...
included in this preview. See [Elixir usage and Jetstream](elixir/README.md) for
additional options.
