...
This `bot-testing` branch also provides the desktop preview: encrypted account
settings, searchable local history retained for ten days, ChatGPT/OpenAI setup,
and an explicit automatic-mode action. See [the desktop guide](docs/DESKTOP.md)
for source builds and native CI downloads.
