...
**[v0.53.2](https://github.com/buntatoes/chorusdraft/releases/tag/v0.53.2)**
is the current published GitHub Release. Earlier GitHub Releases keep their
notes; packages for those versions are not published.
